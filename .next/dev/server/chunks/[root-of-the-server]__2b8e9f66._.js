...
async function GET() {
    try {
        ...
        const batches = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].productionBatch.findMany({
            orderBy: {
                createdAt: "desc"
            },
            take: 10
        ...
        const allProducts = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].product.findMany();
        // Group products by location and calculate totals
        const cuartoFrio1 = allProducts.filter((p)=>p.location === "CUARTO_FRIO_1").sort((a, b)=>b.current_stock - a.current_stock);
        const cuartoFrio1Total = cuartoFrio1.reduce((sum, p)=>sum + p.current_stock, 0);
        const cuartoFrio1TopProducts = cuartoFrio1.slice(0, 3);
        const cuartoFrio2 = allProducts.filter((p)=>p.location === "CUARTO_FRIO_2").sort((a, b)=>b.current_stock - a.current_stock);
        ...
        const orders = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].order.findMany({
            where: {
                status: "PENDING"
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2b8e9f66._.js.map