...
"[project]/node_modules/@tidbcloud/serverless/dist/index.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@tidbcloud/prisma-adapter/dist/index.mjs [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "PrismaTiDBCloud",
    ()=>PrismaTiDBCloudAdapterFactory
]);
// src/tidbcloud.ts
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tidbcloud$2f$serverless$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tidbcloud/serverless/dist/index.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$prisma$2f$driver$2d$adapter$2d$utils$2f$node_modules$2f40$prisma$2f$debug$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@prisma/driver-adapter-utils/node_modules/@prisma/debug/dist/index.mjs [app-route] (ecmascript)");
// src/conversion.ts
...
function fieldToColumnType(field) {
    switch(field){
        ...
        case "SET":
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$prisma$2f$driver$2d$adapter$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ColumnTypeEnum"].Set;
        case "ENUM":
...
// src/tidbcloud.ts
var debug = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$prisma$2f$driver$2d$adapter$2d$utils$2f$node_modules$2f40$prisma$2f$debug$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Debug"])("prisma:driver-adapter:tidbcloud");
...
var TiDBCloudQueryable = class {
   ...
   */ async performIO(query) {
        ...
        try {
            const result = await this.client.execute(sql, values.map((val, i)=>mapArg(val, query.argTypes[i])), {
                arrayMode: true,
                fullResult: true,
...
var PrismaTiDBCloudAdapter = class extends TiDBCloudQueryable {
    ...
    async startTransaction(isolationLevel) {
        ...
        if (isolationLevel && !supportedLevels.includes(isolationLevel)) {
            throw new Error(`TiDBCloud prisma-adapter does not support the isolation level ${isolationLevel}`);
        }
...
var PrismaTiDBCloudAdapterFactory = class {
    ...
    adapterName = name;
    async connect() {
        return new PrismaTiDBCloudAdapter(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tidbcloud$2f$serverless$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Connection"](this.config));
    }
};
;
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7c1433f2._.js.map